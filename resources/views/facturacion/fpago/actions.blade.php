<div class="btn-group m-0">
    <td>
        @can('facturacion.fpago.edit')
        <a title="Editar" href="{{route('fpago.edit', $id)}}" data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-default" style="height: 32px; padding-bottom: 3px; padding-top: 3px;"><i class="fa fa-edit text-warning"></i></a>
        @endcan
    </td>
    <td>
        @can('facturacion.fpago.destroy')
        <form class=" inline form-eliminar" method="post" action="{{ route('fpago.destroy', $id)}}">
            @csrf @method('DELETE')
