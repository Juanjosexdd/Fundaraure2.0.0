    ...
    <div class="col-xs-12">
      <div class="card card-solid card-default">
        <div class="card-header mailbox-controls">
          <h3 class="card-title">Detalle estado {{ $estado->nombre }} </h3>
        ...
        <div class="card-body table-responsive p-1 m-1">
          <div class="col-md-10 offset-1">
            <div class="callout callout-info">
              ...
              <hr>
              <h5> Abreviatura: </h5>
              <p>{{ $estado->abreviado}}</p>
              <hr>
              <h5> Estatus: </h5>
              <p>{{ $estado->estatus}}</p>
            </div>
            <a href="{{route('estado.edit', $estado->id)}}" class="btn bg-info btn-default btn-block btn-sm"><i class="fa fa-edit"></i> Editar</a>
          </div>
        </div>
      </div>
    </div>
