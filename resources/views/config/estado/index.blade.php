  ...
  <section class="content">
    <div class="col-xs-12">
      <div class="card card-solid card-default">
        ...
        <h3 class="card-title"><i class="fas fa-list text-teal"></i> Listado estado</h3>
          @can('config.estado.create')
          <a href="{{ route('estado.create') }}" title="Crear nuevo registro" data-toggle="tooltip" data-placement="left" class="btn btn-default btn-sm elevation-1 float-right">&nbsp;&nbsp;<i class="fas fa-plus text-teal"></i>&nbsp;&nbsp;</a>
          @endcan
        </div>
        <!-- /.card-header -->
        <div class="card-body table-responsive p-1 m-1">
          <table id="listadoestado" class="table table-condensed table-hover p-0">
            <thead>
