    ...
    <div class="col-xs-12">
      <div class="card card-solid card-default">
        <div class="card-header mailbox-controls">
          <h3 class="card-title">&nbsp;&nbsp;Listado estado</h3>
          @can('estado.create')
          <a class="btn bg-teal btn-xs float-right" title="Crea un nuevo registro" data-toggle="tooltip" data-placement="left" href="{{ route('estado.create')}}">&nbsp;&nbsp;<i class="fas fa-plus"></i>&nbsp;&nbsp;</a>
          @endcan
        </div>
        <!-- /.card-header -->
