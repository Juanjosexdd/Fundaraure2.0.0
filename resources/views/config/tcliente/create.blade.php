  ...
  <section class="content">
    <div class="col-xs-12">
      <div class="card">
        ...
        <h3 class="card-title"><i class="fa fa-edit text-warning"></i> Registrar tipo cliente</h3>
        ...
        <div class="card-body">
          <div class="col-md-12">
            <form method="POST" action="{{ route('tcliente.store') }}">
              @csrf
              @include('config.tcliente.partials.form',['btnText'=>'Guardar'])
            </form>
          </div>
        </div>
      </div>
