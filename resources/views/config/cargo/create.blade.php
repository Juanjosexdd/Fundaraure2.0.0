    ...
    <div class="col-xs-12">
      <div class="card">
        <div class="card-header with-border mailbox-controls">
          <h3 class="card-title"> <i class="fa fa-edit text-warning"></i> Registrar cargo</h3>
        ...
        <div class="card-body">
          <div class="col-md-12">
            <form method="POST" class="form-horizontal" action="{{ route('cargo.store') }}">
              @csrf
              @include('config.cargo.partials.form',['btnText'=>'Guardar'])
            </form>
          </div>
        </div>
      </div>
